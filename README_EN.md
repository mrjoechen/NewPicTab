...
- PicTab contacts your selected image sources, TMDB, Open-Meteo, or BigDataCloud only when the corresponding feature is in use. Search-engine icons are bundled; the selected search engine receives a query only after you submit it.
